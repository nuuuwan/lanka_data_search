...
export default class MultiLineChart extends Component {
  ...
  static getChartOptions(datasetList) {
    let titleText = "";
    let subtitleText = "";
  ...
  async componentDidMount() {
    const { datasetList, dataResultList, options } = this.props;
    ...
    let chartOptions = MultiLineChart.getChartOptions(datasetList);
    ...
    const datasets = MultiLineChart.getDataSets(
      dataResultList,
      labels,
      datasetList,
      chartOptions,
  ...
  render() {
    ...
    const { dataResultList, refChart } = this.props;
